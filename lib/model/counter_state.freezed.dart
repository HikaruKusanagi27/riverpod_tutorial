...
part of 'model/counter_state.dart';
...
class _$CounterStateCopyWithImpl<$Res, $Val extends CounterState>
  ...
  @override
  $Res call({Object? count = null, Object? message = null}) {
    return _then(
      _value.copyWith(
            count:
                null == count
...
class _$CounterStateImpl implements _CounterState {
  const _$CounterStateImpl({this.count = 0, this.message = ''});
  ...
  @override
  String toString() {
    return 'CounterState(count: $count, message: $message)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$CounterStateImplToJson(this);
  }
}

abstract class _CounterState implements CounterState {
  const factory _CounterState({final int count, final String message}) =
      _$CounterStateImpl;
